...
GEONODE_DB_CONN_TOUT = int(os.getenv('GEONODE_DB_CONN_TOUT', 30))
...
GEONODE_APPS_ENABLED = ast.literal_eval(os.environ.get('GEONODE_APPS_ENABLED', 'True'))
...
try:
    ...
    ALLOWED_DOCUMENT_TYPES = [
        'm', 'mat', 'sav', 'sps', 'spv', 'spo', 'dta', 'rdata', 'rmd', 'txt', 'log', 'rtf', 'doc', 'docx', 'ods', 'odt', 'sld', 'qml', 'xls', 'xlsx', 'xml',
        'bm', 'bmp', 'dwg', 'dxf', 'fif', 'gif', 'jpg', 'jpe', 'jpeg', 'png', 'tif', 'nc', 'cdf', 'hdf', 'csv', 'tsv',
        'tiff', 'pbm', 'odp', 'ppt', 'pptx', 'pdf', 'tar', 'tgz', 'rar', 'gz', '7z',
        'zip', 'aif', 'aifc', 'aiff', 'au', 'mp3', 'mpga', 'wav', 'afl', 'avi', 'avs', 'py', 'r',
...
SESSION_COOKIE_AGE = 1 * 24 * 60 * 60  # 1 day
...
DISPLAY_SOCIAL = ast.literal_eval(os.getenv('DISPLAY_SOCIAL', 'False'))
...
DISPLAY_VERSIONS = ast.literal_eval(os.getenv('DISPLAY_VERSIONS', 'True'))
...
TINYMCE_DEFAULT_CONFIG = {
    "theme": "silver",
    "height": 340,
    "plugins": 'print preview paste importcss searchreplace autolink autosave save directionality code visualblocks visualchars fullscreen image link media template codesample table charmap hr pagebreak nonbreaking anchor insertdatetime advlist lists wordcount textpattern noneditable help charmap quickbars emoticons',  # noqa
    ...
    "setup": 'function(editor) { editor.on("paste change input undo redo", onInputChange) }'
}
...
EXTRA_METADATA_SCHEMA = {**{
    ...
    "dataset": os.getenv('DOCUMENT_EXTRA_METADATA_SCHEMA', DEFAULT_EXTRA_METADATA_SCHEMA),
