        ...
        if instance:
                ...
                with transaction.atomic():
                    ...
                    if isinstance(instance.get_real_instance(), Layer):
                        for attribute in Attribute.objects.filter(layer=instance.get_real_instance()):
                            ...
                            _attribute.layer = _resource.get_real_instance()
                            _attribute.save()
            ...
            if _resource:
                try:
                    ...
                    if 'user' in to_update:
                        to_update.pop('user')
                    # We need to remove any public access to the cloned layer here
                            ...
                            for perm in _perm_spec["groups"][anonymous_group]:
                                if _resource_type == 'layer' and perm in (
                                    ...
                                    if perm == 'change_layer_style' and _resource_subtype not in DATA_STYLABLE_RESOURCES_SUBTYPES:
                                        ...
                                        _safe_assign_perm(perm, anonymous_group, _resource.layer)
