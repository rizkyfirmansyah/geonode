    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default_access_permissions', django_jsonfield_backport.models.JSONField(default=dict, help_text='Default access permissions of harvested resources')),
                ...
                ('harvester_type_specific_configuration', django_jsonfield_backport.models.JSONField(default=dict, help_text='Configuration specific to each harvester type. Please consult GeoNode documentation on harvesting for more info.')),
