...
class RemoteLayerType(enum.Enum):
    VECTOR = "shapefile"
    RASTER = "geotiff"
...
class GeonodeCurrentHarvester(base.BaseHarvesterWorker):
    ...
    def get_geonode_resource_type(self, remote_resource_type: str) -> typing.Type[typing.Union[Layer, Document]]:
        return {
            GeoNodeResourceTypeCurrent.LAYER.value: Layer,
    ...
    def get_resource(
        ...
        url_fragment = {
            GeoNodeResourceTypeCurrent.LAYER.value: "/layers/",
    ...
    def should_copy_resource(
        ...
        return {
            GeoNodeResourceTypeCurrent.LAYER.value: self.copy_layers,
    ...
    def get_geonode_resource_defaults(
        ...
        elif local_resource_type == Layer:
            defaults.update({
                "name": harvested_info.resource_descriptor.identification.name
            })
            if not to_copy:
                # since we are not copying the layer, we need to provide suitable SRID and remote URL
                try:
    ...
    def _get_resource_link_info(
        ...
        if remote_resource_type == GeoNodeResourceTypeCurrent.LAYER.value:
    ...
    def _get_resource_descriptor(
        ...
        elif remote_resource_type == GeoNodeResourceTypeCurrent.LAYER.value:
    ...
    def _get_resource_list_params(
        ...
        if self.harvest_layers:
            resource_filter.append(GeoNodeResourceTypeCurrent.LAYER.value)
...
class GeonodeLegacyHarvester(base.BaseHarvesterWorker):
    ...
    def should_copy_resource(
        ...
        return {
            ...
            GeoNodeResourceType.LAYER.value: self.copy_layers,
    ...
    def _get_resource_descriptor(
        ...
        additional_params_handler = {
            GeoNodeResourceType.LAYER.value: self._get_dataset_additional_parameters,
    ...
    def _get_dataset_additional_parameters(
        ...
        if descriptor.identification.native_format.lower() == RemoteLayerType.VECTOR.value:
            result["subtype"] = GeonodeLayerType.VECTOR.value
        elif descriptor.identification.native_format.lower() == RemoteLayerType.RASTER.value:
            result["subtype"] = GeonodeLayerType.RASTER.value
        return result
