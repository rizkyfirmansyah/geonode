    ...
    def test_layer_upload_metadata(self):
        ...
        try:
            if os.path.exists(thelayer):
                ...
                # Set
                from geonode.base.utils import resolve_regions
...
class GeoNodeThumbnailTest(GeoNodeLiveTestSupport):
    ...
    def test_layer_thumbnail(self):
        ...
        try:
            ...
            self.assertNotEqual(thumbnail_url, static(MISSING_THUMB))
        finally:
            # Cleanup
            saved_layer.delete()
    ...
    def test_map_thumbnail(self):
        ...
        try:
            ...
            self.assertEqual(thumbnail_url, static(MISSING_THUMB))
        finally:
            # Cleanup
            saved_layer.delete()
