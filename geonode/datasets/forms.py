    ...
    def save_many2many(self, links_field='links'):
        ...
        for link in self.cleaned_data[links_field]:
            ...
            if matches:
                ...
                instance, _ = FileResourceLink.objects.get_or_create(
...
class DatasetForm(ResourceBaseForm, FileFormMixin):
...
class DatasetCreateForm(TranslationModelForm, FileFormMixin):
