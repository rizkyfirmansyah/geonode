...
from geonode.datasets.views import dataset_download
...
class DocumentsApiTests(APITestCase, URLPatternsTestCase):
    ...
    urlpatterns = [
        ...
        url(r'^(?P<docid>\d+)/download/?$', dataset_download, name='dataset_download'),
        ...
        url(r'^$',
            ...
            name='maps_browse'),
        url(r'^$',
            TemplateView.as_view(template_name='documents/dataset_list.html'),
