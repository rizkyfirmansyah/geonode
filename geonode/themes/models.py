...
class GeoNodeThemeCustomization(models.Model):
    ...
    navbar_text_hover = models.CharField(max_length=10, default="#f0ab00")
    navbar_text_hover_focus = models.CharField(max_length=10, default="#f0ab00")
    navbar_dropdown_menu = models.CharField(max_length=10, default="#f0ab00")
    navbar_dropdown_menu_text = models.CharField(max_length=10, default="#ffffff")
    navbar_dropdown_menu_hover = models.CharField(max_length=10, default="#eea200")
    navbar_dropdown_menu_divider = models.CharField(max_length=10, default="#eea200")
    jumbotron_color = models.CharField(max_length=10, default="#f0ab00")
    ...
    copyright_color = models.CharField(max_length=10, default="#f0ab00")
    ...
    cookie_law_info_background = models.CharField(max_length=30, default="#f0ab00")
    ...
    cookie_law_info_button_1_link_colour = models.CharField(max_length=30, default="#f0ab00")
    ...
    cookie_law_info_button_2_link_colour = models.CharField(max_length=30, default="#f0ab00")
    ...
    cookie_law_info_button_3_link_colour = models.CharField(max_length=30, default="#f0ab00")
    ...
    cookie_law_info_button_4_link_colour = models.CharField(max_length=30, default="#f0ab00")
