...
class GeoNodeThemeCustomization(models.Model):
    ...
    navbar_text_hover = models.CharField(max_length=10, default="#F39F1E")
    navbar_text_hover_focus = models.CharField(max_length=10, default="#F39F1E")
    navbar_dropdown_menu = models.CharField(max_length=10, default="#F39F1E")
    ...
    jumbotron_color = models.CharField(max_length=10, default="#F39F1E")
    ...
    copyright_color = models.CharField(max_length=10, default="#F39F1E")
    ...
    cookie_law_info_background = models.CharField(max_length=30, default="#F39F1E")
    ...
    cookie_law_info_button_1_link_colour = models.CharField(max_length=30, default="#F39F1E")
    ...
    cookie_law_info_button_2_link_colour = models.CharField(max_length=30, default="#F39F1E")
    ...
    cookie_law_info_button_3_link_colour = models.CharField(max_length=30, default="#F39F1E")
    ...
    cookie_law_info_button_4_link_colour = models.CharField(max_length=30, default="#F39F1E")
