...
from geonode.base.forms import ResourceVersionForm, BatchEditForm
...
def ModalForm(request):
    return {
        ...
        'version_form': ResourceVersionForm(),
        'permissions_form': PermissionsForm(user=request.user),
        'bulk_metadata_form': BatchEditForm()
    }