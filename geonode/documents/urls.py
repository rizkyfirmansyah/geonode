...
urlpatterns = [  # 'geonode.documents.views',
    ...
    url(r'^(?P<docid>\d+)/replace$', DocumentUpdateView.as_view(),
    ...
    url(r'^upload/?$', DocumentUploadView.as_view(), name='document_upload'),
    ...
    url(r'^metadata/batch/$',
        views.document_batch_metadata, name='document_batch_metadata'),
    url(r'^(?P<docid>\d+)/metadata_advanced$', views.document_metadata_advanced,
        name='document_metadata_advanced'),
    url(r'^permissions/batch/$',
        views.document_batch_permissions, name='document_batch_permissions'),
    url(r'^autocomplete/$',
