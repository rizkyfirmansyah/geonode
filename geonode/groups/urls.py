...
from .views import GroupCategoryDetailView, GroupDetailView, GroupActivityView, SetGroupLayerPermission
from . import views
...
urlpatterns = [  # 'geonode.groups.views',
    ...
    url(r'^group/(?P<slug>[-\w]+)/request/$',
        views.group_join_request, name='group_join_request'),
