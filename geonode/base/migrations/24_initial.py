    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(default='eng', help_text='language used within the dataset', max_length=3, verbose_name='language', choices=[('eng','English'),  ('ind','Indonesian')])),
