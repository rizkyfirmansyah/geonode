    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.CharField(max_length=2000, help_text='People/organizations that contributed to the data set (separate by commas), or link to the journal article, from which institutions the data was obtained', verbose_name='source', null=True, blank=True)),
                ...
                ('spatial_resolution', models.CharField(help_text='describes the spatial resolution: e.g. 1:50.000 or 30m', verbose_name='Spatial Resolution/Scale', max_length=255, null=True, blank=True)),
